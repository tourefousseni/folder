...
class Person(models.Model):
    ...
    def __str__(self):
        return '%s %s %s'%(self.prenom, self.nom, self.contact)
...
class Command(models.Model):
    ...
    modele = models.CharField(max_length=30, null=True, blank=True)
    tissu = models.CharField(max_length=30, null=True, blank=True)
